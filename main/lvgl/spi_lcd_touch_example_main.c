...
#define EXAMPLE_PIN_NUM_MISO           27
#define EXAMPLE_PIN_NUM_LCD_DC         22
#define EXAMPLE_PIN_NUM_LCD_RST        19
#define EXAMPLE_PIN_NUM_LCD_CS         12
#define EXAMPLE_PIN_NUM_BK_LIGHT       -1
#define EXAMPLE_PIN_NUM_TOUCH_CS       13
#define EXAMPLE_PIN_NUM_TOUCH_PEN_DOWN      21
...
void app_main_lvgl_drv(void)
{
    ...
    esp_lcd_touch_config_t tp_cfg = {
        ...
        .rst_gpio_num = -1,
        .int_gpio_num = EXAMPLE_PIN_NUM_TOUCH_PEN_DOWN,
        .flags = {
            .swap_xy = 0,
            .mirror_x = 0,
            .mirror_y = 0,
